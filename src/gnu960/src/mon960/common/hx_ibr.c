...
#if BIG_ENDIAN_CODE
	BYTE_N(0, REGION_BOOT_CONFIG) << 24,
	BYTE_N(1, REGION_BOOT_CONFIG) << 24,
	BYTE_N(2, REGION_BOOT_CONFIG) << 24,
	BYTE_N(3, REGION_BOOT_CONFIG) << 24,
#else
	BYTE_N(0, REGION_BOOT_CONFIG),
	BYTE_N(1, REGION_BOOT_CONFIG),
	BYTE_N(2, REGION_BOOT_CONFIG),
	BYTE_N(3, REGION_BOOT_CONFIG),
