...
#if BIG_ENDIAN_CODE
	BYTE_N(0, REGION_F_CONFIG) << 24,
	BYTE_N(1, REGION_F_CONFIG) << 24,
	BYTE_N(2, REGION_F_CONFIG) << 24,
	BYTE_N(3, REGION_F_CONFIG) << 24,
#else
	BYTE_N(0, REGION_F_CONFIG),
	BYTE_N(1, REGION_F_CONFIG),
	BYTE_N(2, REGION_F_CONFIG),
	BYTE_N(3, REGION_F_CONFIG),
