 ...
 * board identifier
 *********************************************************************/
int arch = ARCH_SB;      	/* Processor type */
char arch_name[32] = "SB";	/* add speed annd mem size in cpu_identify() */

char target_common_name[] = "cysx";     /* Informal target name */
...
init_hardware()
{
	 ...
	 * int0: vector e2 for timer
	 * int1: f2 break vector
	 */
