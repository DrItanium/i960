...
clear_pend_wait:
    ...
    /* As per i960 Jx microprocessor user's guide, loop until pend bit clears */
    ld       (g1), r11
...
/*
 * Warning -- don't modify this function without also modifying the
 * function determine_if_jd() in the file jx_step.c .
 */
	.globl	_jx_tight_loop
_jx_tight_loop:
    ldconst 0, r5      /* i => 0, loop_count => g0 */
tight_loop:
    addo    r5, 1, r5   /* 1 cycle */
    cmpo    r5, g0      /* 1 cycle */
    bl      tight_loop  /* 2 cycles 99.99% of time */
    ret
