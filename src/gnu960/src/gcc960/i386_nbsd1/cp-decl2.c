...
#ifdef IMSTG
  /* In the gcc960's scheme of things the name of the function containing 
     constructor and destructor invocations does not have to be global. 
     So make it local in the file scope to avoid potential name conflicts */
...
#else
	      imstg_emit_line_note (input_filename, lineno, DECL_SOURCE_POS(decl), 0);
#endif
