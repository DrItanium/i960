...
#endif /* not USG */
#else
#include "stab.h"  /* include our stab.h */
#endif
...
{
#ifdef IMSTG
#ifdef OUTPUT_DBX_ARG_PTR_DEF
  int dbx_arg_ptr_def_out = 0;
#endif
#endif
...
#ifdef IMSTG
#ifdef OUTPUT_DBX_ARG_PTR_DEF
            if (current_sym_code == N_PSYM && !dbx_arg_ptr_def_out)
            {
              OUTPUT_DBX_ARG_PTR_DEF();
              dbx_arg_ptr_def_out = 1;
            }
#endif
#endif
	    if (DECL_NAME (parms))
