...
#if defined(IMSTG)
#define XA 	bfd_mach_i960_xa    /*4*/
#define CA 	bfd_mach_i960_ca    /*5*/
#define JX 	bfd_mach_i960_jx    /*6*/
#else
...
#if defined(IMSTG)
    {
    	{ ERROR,CORE,	KA,	KB,	XA,	CA,	JX },
	{ CORE,	CORE,	KA,	KB,	XA,	CA,	JX },
	{ KA,	KA,	KA,	KB,	XA,	ERROR,	ERROR },
    	{ KB,	KB,	KB,	KB,	XA,	ERROR,	ERROR },
	{ XA,	XA,	XA,	XA,	XA,	ERROR,	ERROR },
	{ CA,	CA,	ERROR,	ERROR,	ERROR,	CA,	JX },
	{ JX,	JX,	ERROR,	ERROR,	ERROR,	JX,	JX }
    };
#else
    {
...
{ 
  ...
  N(bfd_mach_i960_jx,"i960:jx",false)
#else
