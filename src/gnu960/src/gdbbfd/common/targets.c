...
#if defined(IMSTG)
/* We use only 6 vectors.
   FIXME: This #define should be expressed in the Makefile. */
#define SELECT_VECS &icoff_little_vec,&icoff_big_vec,&b_out_vec_little_host,&b_out_vec_big_host,&bfd_elf32_little_generic_vec,&bfd_elf32_big_generic_vec
#endif
