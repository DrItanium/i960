...
extern void
count_dynamic_calls DB_PROTO((call_graph *cg));

extern void
get_func_prof DB_PROTO((call_graph_node *cgn_p));

extern void
prof_call_count DB_PROTO((call_graph *cg));

extern void
print_cg_counts DB_PROTO((call_graph *cg, int extra));
