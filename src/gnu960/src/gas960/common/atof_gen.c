...
/* static const char rcsid[] = "$Id: atof_gen.c,v 1.7 1995/10/12 20:57:22 paulr Exp $"; */
...

  {
	...
	((first_digit[0] == 'Q' || first_digit[0] == 'q') && ISNAN(first_digit+1))) {
	address_of_generic_floating_point_number->sign='Q';
	address_of_generic_floating_point_number->exponent=0;
	address_of_generic_floating_point_number->leader=address_of_generic_floating_point_number->low;
	(*address_of_string_pointer)=first_digit + (ISNAN(first_digit) ? 3 : 4);
	return 0;
    }
    if ((first_digit[0] == 'S' || first_digit[0] == 's') && ISNAN(first_digit+1)) {
	address_of_generic_floating_point_number->sign='S';
	address_of_generic_floating_point_number->exponent=0;
	address_of_generic_floating_point_number->leader=address_of_generic_floating_point_number->low;
...
(void)putchar('\n');
#endif
		      flonum_multip((FLONUM_TYPE *)multiplicand + place_number, &power_of_10_flonum, &temporary_flonum);
