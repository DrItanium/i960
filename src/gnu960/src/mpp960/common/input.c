 ...
 *
 * The macro "mppwrap" places the text to be saved on another input
 ...
 * will suffice, as long as arguments to m4_mppwrap () are moderate in
 * size.
 */
void
push_wrapup (char *s)
