...
#ifdef __STDC__
static eval_error logical_or_term (eval_token et, int *v1);
static eval_error logical_and_term (eval_token et, int *v1);
static eval_error xor_term (eval_token et, int *v1);
static eval_error or_term (eval_token et, int *v1);
static eval_error and_term (eval_token et, int *v1);
static eval_error not_term (eval_token et, int *v1);
static eval_error cmp_term (eval_token et, int *v1);
static eval_error add_term (eval_token et, int *v1);
static eval_error mult_term (eval_token et, int *v1);
static eval_error exp_term (eval_token et, int *v1);
static eval_error unary_term (eval_token et, int *v1);
static eval_error simple_term (eval_token et, int *v1);
#else
