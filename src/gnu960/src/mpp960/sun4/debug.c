...
/*
 *  error_out puts all errors out via "debug"
 *   This will ensure that most, but not all, error messages can
 *   be redirected by the "-e" switch.
 */
