...
#if ! (defined(IBM6000_TARGET) || defined(IMSTG))
     ...
     int verbo;
{
  ...
  /* Give target a poke when symbols are read or re-read.
     No distinction between mainline or not. */
  target_clear_symtab_users ();
