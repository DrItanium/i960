...
struct context_stack
{
  ...
  /* For nesting different types of concrete instance trees: is the 
     parent of this context a concrete out-of-line instance or is it
     a concrete inlined instance? */
  PTR concrete_instance_root;
#endif
};
...
extern void
record_line PARAMS ((struct subfile *, int, int, CORE_ADDR));
