...
extern void
vprintf_filtered PARAMS ((char *format, void *args));

extern void
vfprintf_filtered PARAMS ((FILE *stream, char *format, void *args));

extern void
fprintf_filtered PARAMS ((FILE *stream, char *format DOTS));

extern void
fprintfi_filtered PARAMS ((int spaces, FILE *stream, char *format DOTS));

extern void
printf_filtered PARAMS ((char *format DOTS));

extern void
printfi_filtered PARAMS ((int spaces, char *format DOTS));

extern void
vprintf_unfiltered PARAMS ((char *format, void *args));

extern void
vfprintf_unfiltered PARAMS ((FILE *stream, char *format, void *args));

extern void
fprintf_unfiltered PARAMS ((FILE *stream, char *format DOTS));

extern void
printf_unfiltered PARAMS ((char *format DOTS));
...
#if ! defined(IMSTG) /* We are never native */
...
error PARAMS ((char *format DOTS));

extern void error_begin PARAMS ((void));

extern NORETURN void			/* Does not return to the caller.  */
fatal PARAMS ((char *format DOTS));
...
extern void
warning PARAMS ((char *format DOTS));
...
#if defined(IMSTG)
/* We are always i960, so we just hard-wire tm.h to tm-i960.h */
#include "tm-i960.h"
#else
#include "tm.h"
#endif
...
/* We always figure this out at runtime, never at configure */
