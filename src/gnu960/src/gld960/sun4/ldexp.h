...
PROTO(int, invalid,(etree_value_type *));
PROTO(int, exp_fold_tree,(etree_type *,lang_output_section_statement_type *, lang_phase_type,
					bfd_vma, bfd_vma *,etree_value_type *));
...
PROTO(void, exp_print_tree,( FILE *, etree_type *));
PROTO(bfd_vma, exp_get_vma,(etree_type *, bfd_vma, char *, lang_phase_type));
PROTO(int, exp_get_value_int,(etree_type *, int, char *, lang_phase_type));
