...
/******************************************************************************/
/*									      */
/*      rnddfsi.c - Double Precision to Integer Conversion Routine (AFP-960)  */
/*									      */
/******************************************************************************/
...
___rounddfsi:
	cmpo	s1_lo,0
	ldconst	0x80000000+((DP_Bias+31) << 20),con_1
	...
	cmpo	con_1,tmp
	shlo	1,s1_hi,s2_exp
	bl	LLcnv_90			/* J/ invalid operation -> neg val */
	shro	32-11,s2_exp,s2_exp
	ldconst	DP_Bias+31,con_1
	cmpo	s2_exp,con_1
	shri	31,s1_hi,s2_sign	/* -1 or 0 based on sign */
	...
	bl	Lcnv_20			/* J/ magnitude < 1/2 -> limit shift */
...
Lcnv_14:
	...
	addc	0,out,out
	bg	LLcnv_19x			/* J/ possible overflow */
...
LLcnv_19x:
	cmpobne	0,s2_sign,Lcnv_16	/* J/ no overflow */
	b	Lcnv_82			/* Positive overflow */
