...
/* function:  _yn(n,x)
 *     Calculate Bessel function Yn(X) for any integer n and any positive X.
 *
...
double x;
{
    ...
    /*
     * This function uses the recursive relation, which is
     * upward stable:
     *
     *        Y(n+1, x) = (2n/x)*Y(n, x) - Y(n-1, x)
     *
     */
