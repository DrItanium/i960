...
#else
static __inline  int BIAS() 
{  register int i; void  *malloc(); 
   asm ("lda (0-_malloc)(%1),%0":"=&d"(i):"d"(&malloc));
   return i;
}
#define JUMP_FIELD(TYPE, NAME) struct { short delta1, delta2; TYPE pfn; } NAME
#define JUMP0(FUNC, THIS) (_IO_JUMPS(THIS)->FUNC.pfn+BIAS())(THIS) 
#define JUMP1(FUNC, THIS, X1) (_IO_JUMPS(THIS)->FUNC.pfn+BIAS())(THIS, X1)
#define JUMP2(FUNC, THIS, X1, X2) (_IO_JUMPS(THIS)->FUNC.pfn+BIAS())(THIS, X1, X2)
#define JUMP3(FUNC, THIS, X1,X2,X3) (_IO_JUMPS(THIS)->FUNC.pfn+BIAS())(THIS, X1,X2, X3)
#endif
