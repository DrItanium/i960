...
#define __DCACHE_H__
	...
	|| defined(__i960JL) || defined(__i960RP) || defined(__i960RD) \
	|| defined(__i960JT) || defined(__i960HA) || defined(__i960HD) || defined(__i960HT))\
     && !defined(__CORE1) && !defined(__CORE3)
...
% reglit set1; tmpreg set2; reglit mem; void return; spillall;
	...
	dcctl	6,mem,set2
     ...
     && !defined(__CORE1) && !defined(__CORE0) && !defined(__CORE3) && \
    !defined(__CORE2)
