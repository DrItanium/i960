...
#define __NO_FPU
    ...
    defined(__i960_JL__) || defined(__i960_JT__) || defined(__i960_RP__) ||\
    defined(__i960_RD__) || defined(__i960CA)    || defined(__i960CF)    ||\
    defined(__i960JA)    || defined(__i960JD)    || defined(__i960JF) ||\
    defined(__i960JL)    || defined(__i960RP)) && !defined(__CORE1)
...
__EXTERN int __builtin_argsize();
__EXTERN void *__builtin_argptr();
